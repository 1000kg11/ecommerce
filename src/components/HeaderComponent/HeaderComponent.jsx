...
useEffect(() =>{
  ...
  return (
    <div style={{with: '100%', background: 'rgb(26, 148, 255)', display: 'flex', justifyContent: 'center'}} >
      <WrapperHeader style={{justifyContent: isHiddenSearch && isHiddenCart ? 'space-between': 'unset'}}>
        <Col span={5}>
          <WrapperTextHeader to = '/'>LapTrinhKhovl</WrapperTextHeader>
        </Col>
        {!isHiddenSearch && (
         <Col span={13}>
         <ButtonInputSearch 
